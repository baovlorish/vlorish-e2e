...
class TextFieldWithSuggestion<T> extends StatefulWidget {
  ...
  @override
  _TextFieldWithSuggestionState createState() => _TextFieldWithSuggestionState();
}
      ...
      children: [
        ...
        TypeAheadFormField<T>(
          ...
          textFieldConfiguration: TextFieldConfiguration(
            ...
            onEditingComplete: widget.model is String
                ? () async {
                    if (controller.text.length == 2) {
                      var searchResult = await widget.search(controller.text) as List<T>;
                ...
                : () {},
            inputFormatters: [LengthLimitingTextInputFormatter(widget.maxSymbols)],
            ...
            decoration: InputDecoration(
              ...
              enabledBorder: OutlineInputBorder(
                borderSide: BorderSide(color: CustomColorScheme.inputBorder, width: 1.0),
                borderRadius: BorderRadius.circular(5.0),
              ),
              errorStyle: CustomTextStyle.ErrorTextStyle(context),
              errorBorder: OutlineInputBorder(
                borderSide: BorderSide(color: CustomColorScheme.inputErrorBorder, width: 1.0),
                borderRadius: BorderRadius.circular(5.0),
              ),
              border: OutlineInputBorder(
                borderSide: BorderSide(color: CustomColorScheme.inputBorder, width: 2.0),
                borderRadius: BorderRadius.circular(5.0),
              ),
              errorMaxLines: 5,
              hintMaxLines: 2,
              hintText: widget.hintText,
              hintStyle: CustomTextStyle.HintNewTextStyle(context),
            ),
          ),
          hideOnLoading: true,
