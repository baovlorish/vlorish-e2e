            ...
            ? ButtonStyle(
                ...
                backgroundColor: enabled
                    ? buttonType == ButtonType.White
                        ...
                        : MaterialStateProperty.all<Color>(CustomColorScheme.button)
                    : MaterialStateProperty.all<Color>(CustomColorScheme.dividerColor),
              )
            : ButtonStyle(
                padding: MaterialStateProperty.all<EdgeInsets>(EdgeInsets.zero),
                ...
                backgroundColor: MaterialStateProperty.all<Color>(CustomColorScheme.dividerColor),
              ),
        child: Container(
          padding: buttonType == ButtonType.SmallText || isSmallButton ? EdgeInsets.all(10) : EdgeInsets.all(16),
          ...
          child: Center(
            child: Label(
              text: text,
              type: buttonType == ButtonType.SmallText || isSmallButton ? LabelType.Button : LabelType.LargeButton,
              color: buttonType == ButtonType.White ? CustomColorScheme.button : CustomColorScheme.blockBackground,
            ),
          ),
        ),
      );
