...
class TermsAndConditionsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return PolicyScreen(
      title: AppLocalizations.of(context)!.termsHeadline,
      ...
      child: CustomSelectableText(
        ...
        childrenTextData: [
          ...
          SelectableTextData(
            text: 'Intellectual property right\n',
            type: SelectableTextType.Header,
          ),
          SelectableTextData(
            text:
          ...
          SelectableTextData(
            text: 'Mobile application license\n',
            type: SelectableTextType.Header,
          ),
          SelectableTextData(
            text: 'Use license\n',
          ...
          SelectableTextData(
            text: 'Apple and Android Devices\n',
            type: SelectableTextType.SubHeader,
          ),
          SelectableTextData(
            text:
          ...
          SelectableTextData(
            text:
                '. Your arbitration fees and your share of arbitrator compensation shall be governed by the AAA Consumer Rules and, where appropriate, limited by the AAA Consumer Rules. The arbitration may be conducted in person, through the submission of documents, by phone, or online. The arbitrator will make a decision in writing, but need not provide a statement of reasons unless requested by either Party. The arbitrator must follow applicable law, and any award may be challenged if the arbitrator fails to do so. Except where otherwise required by the applicable AAA rules or applicable law, the arbitration will take place in Hennepin, Minnesota. Except as otherwise provided herein, the Parties may litigate in court to compel arbitration, stay proceedings pending arbitration, or to confirm, modify, vacate, or enter judgment on the award entered by the arbitrator. \nIf for any reason, a Dispute proceeds in court rather than arbitration, the Dispute shall be commenced or prosecuted in the state and federal courts located in Hennepin, Minnesota, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction, and forum non convenience with respect to venue and jurisdiction in such state and federal courts. Application of the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) are excluded from these Terms of Use. \nIn no event shall any Dispute brought by either Party related in any way to the Site be commenced more than 6 months after the cause of action arose. If this provision is found to be illegal or unenforceable, then neither Party will elect to arbitrate any Dispute falling within that portion of this provision found to be illegal or unenforceable and such Dispute shall be decided by a court of competent jurisdiction within the courts listed for jurisdiction above, and the Parties agree to submit to the personal jurisdiction of that court.\n',
          ),
          SelectableTextData(
            text: 'Restrictions\n',
            type: SelectableTextType.SubHeader,
