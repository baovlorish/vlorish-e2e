  ...
  static void initRoute(FluroRouter router, UserContractor diContractor,
    ...
    var handler = Handler(
      handlerFunc: (BuildContext? context, Map<String, List<String>> params) {
        var filters = context?.settings?.arguments as TransactionFiltersModel?;
        return diContractor.authRepository.sessionExists()
            ? BlocProvider<HomeScreenCubit>(
                ...
                child: HomePage(
                  innerBlocProvider:
                      BlocProvider<BankAccountsAndStatisticsBloc>(
                    lazy: false,
                    create: (_) => BankAccountsAndStatisticsBloc(
                      diContractor.accountsTransactionsRepository,
                      diContractor.categoryRepository,
                      initialFilters: filters,
                    ),
                    child: TransactionsLayout(),
                  ),
