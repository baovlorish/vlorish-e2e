...
void main() async {
  ...
  group('Profile Page', () {
    testWidgets('Profile test', (tester, [String? context]) async {
      ...
      try {
        await htLogdDirect(
            'BAR_T208 Check that user can update "Dependents”', '', 'STARTED');
        ...
        await htLogd(tester, 'BAR_T208 Check that user can update "Dependents”',
            '', 'FINISHED');
      } catch (e) {
        await htLogd(
            tester,
            'Failed BAR-T208 Check that user can update "Dependents”',
            '',
            'FINISHED');
      }
      ...
      try {
        await htLogdDirect(
            'BAR_T209 Check that user can update "Relationships status”',
            '',
            'STARTED');
        ...
        await htLogd(
            tester,
            'Failed BAR-T209 Check that user can update "Relationships status”',
            '',
            'FINISHED');
      }
      ...
      try {
        await htLogdDirect(
            'BAR_T210 Check that user can update "Education”', '', 'STARTED');
        ...
        await htLogd(tester, 'BAR_T210 Check that user can update "Education”',
            '', 'FINISHED');
      } catch (e) {
        await htLogd(
            tester,
            'Failed BAR-T210 Check that user can update "Education”',
            '',
            'FINISHED');
      }
      ...
      try {
        await htLogdDirect(
            'BAR_T211 Check that user can update "Employment”', '', 'STARTED');
        ...
        await htLogd(tester, 'BAR_T211 Check that user can update "Employment”',
            '', 'FINISHED');
      } catch (e) {
        await htLogd(
            tester,
            'Failed BAR-T211 Check that user can update "Employment”',
            '',
            'FINISHED');
      }
