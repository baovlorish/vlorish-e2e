...
class ForgotPasswordScreenTest {
  ...
  Future<void> verifyForgotPasswordPage(WidgetTester tester, {String context = ''}) async {
    await tester.pumpAndSettle();
    ...
    await htExpect(tester, find.widgetWithText(ButtonItem, 'Next'), findsOneWidget,
  ...
  Future<void> verifyConfirmEmailPage(WidgetTester tester, {String context = ''}) async {
    await tester.pumpAndSettle();
