...
class SignInScreenTest {
  ...
  Future<void> clickBtnSignUp(WidgetTester tester, {String context = ""}) async {
    await tester.pumpAndSettle();
    final btnSignIn = find.text('Sign-up').first;
    await tapSomething(tester, btnSignIn, addContext(context, "click Btn SignUp"));
  }
  ...
  Future<void> clickForgotPassword(WidgetTester tester, {String context = ''}) async {
    ...
    await tapSomething(tester, btnForgotPass, addContext(context, "Click on btn Forgot password"));
    await tester.pumpAndSettle();
  }
