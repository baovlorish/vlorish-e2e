...
void main() async {
  ...
  group('Authentication Test', () {
    testWidgets('Forgot Password Page', (tester, [String? context]) async {
      ...
      try {
        await htLogdDirect(
            'BAR-T66 User is redirected to the Forgot Password flow pages', '', 'STARTED');
        ...
        await htLogd(
            tester, 'BAR-T66 User is redirected to the Forgot Password flow pages', '', 'FINISHED');
      } catch (e) {
        await htLogd(tester, 'Failed BAR-T66 User is redirected to the Forgot Password flow pages',
            '', 'FINISHED');
      }
      ...
      try {
        await htLogdDirect(
            'BAR-T80 User can leave Forgot Password window by tapping back button', '', 'STARTED');
        await dashboardScreen.clickLogoText();
        await signInScreen.clickForgotPassword(tester, context: context);
        await forgotPassScreen.verifyForgotPasswordPage(tester, context: context);
        await dashboardScreen.clickBack();
        await signInScreen.verifySignInPage(tester, context: context);
        await htLogd(tester, 'BAR-T80 User can leave Forgot Password window by tapping back button',
            '', 'FINISHED');
      } catch (e) {
        await htLogd(
            tester,
      ...
      try {
        ...
        await forgotPassScreen.clickBtnNext(tester, context: context);
        await forgotPassScreen.verifyErrorMessage('Please, enter your email', tester,
            context: context);
        await htLogd(
            tester,
            'BAR-T81 User see error message if click on Next button with empty Email field',
      ...
      try {
        await htLogdDirect('BAR-T82 User can see a confirmation about an email', '', 'STARTED');
        await dashboardScreen.clickLogoText();
        await signInScreen.clickForgotPassword(tester, context: context);
        await forgotPassScreen.verifyForgotPasswordPage(tester, context: context);
        ...
        await htLogd(tester, 'BAR-T82 User can see a confirmation about an email', '', 'FINISHED');
      } catch (e) {
        await htLogd(
            tester, 'Failed BAR-T82 User can see a confirmation about an email', '', 'FINISHED');
      }
      ...
      try {
        ...
        await forgotPassScreen.verifyMessageErrorIsVisible('Confirm Password', tester);
        await htLogd(
            tester,
            'BAR-T84 User sees error message after clicking on "Done" button with empty Password field',
            '',
      ...
      try {
        await htLogdDirect('BAR-T85 Password fields contain at least 8 characters', '', 'STARTED');
        await dashboardScreen.clickLogoText();
        await signInScreen.clickForgotPassword(tester, context: context);
        await forgotPassScreen.verifyForgotPasswordPage(tester, context: context);
        await forgotPassScreen.inputEmail(emailLogin);
        ...
        await forgotPassScreen.inputConfirmPasswordinConfirmEmailScreen('test123');
        await forgotPassScreen.clickBtnNext(tester, context: context);
        await forgotPassScreen.verifyMessageErrorIsVisible(
            'contains at least 8 characters', tester);
        await forgotPassScreen.verifyMessageErrorIsVisible(
        ...
        await htLogd(
            tester, 'BAR-T85 Password fields contain at least 8 characters', '', 'FINISHED');
      } catch (e) {
        await htLogd(
            tester, 'Failed BAR-T85 Password fields contain at least 8 characters', '', 'FINISHED');
      }
      ...
      try {
        ...
        await forgotPassScreen.verifyConfirmEmailPage(tester, context: context);
        await forgotPassScreen.inputPasswordinConfirmEmailScreen('test123');
        await forgotPassScreen.inputConfirmPasswordinConfirmEmailScreen('test1234');
        await forgotPassScreen.clickBtnNext(tester, context: context);
        await forgotPassScreen.verifyMessageErrorIsVisible(
            'contains at least 8 characters', tester);
        await forgotPassScreen.verifyMessageErrorIsVisible(
      ...
      try {
        ...
        await forgotPassScreen.inputConfirmPasswordinConfirmEmailScreen('test12345');
        await forgotPassScreen.clickBtnNext(tester, context: context);
        await forgotPassScreen.verifyMessageErrorIsVisible(
            'contains both lower (a-z) and upper case letters (A-Z)', tester);
        await forgotPassScreen.verifyMessageErrorIsVisible(
      ...
      try {
        ...
        await forgotPassScreen.inputConfirmPasswordinConfirmEmailScreen('testPassword');
        await forgotPassScreen.clickBtnNext(tester, context: context);
        await forgotPassScreen.verifyMessageErrorIsVisible(
            'contains at least one number (0-9) and a symbol', tester,
            context: context);
      ...
      try {
        await htLogdDirect('BAR-T95 Password fields can contain min 8 characters', '', 'STARTED');
        await dashboardScreen.clickLogoText();
        await signInScreen.clickForgotPassword(tester, context: context);
        await forgotPassScreen.verifyForgotPasswordPage(tester, context: context);
        await forgotPassScreen.inputEmail(emailLogin);
        ...
        await forgotPassScreen.clickBtnNext(tester, context: context);
        await forgotPassScreen.verifyErrorMessage(
            'The password should include at least 8 numbers. Please re-enter the password', tester,
            context: context);
        await htLogd(
            tester, 'BAR-T95 Password fields can contain min 8 characters', '', 'FINISHED');
      } catch (e) {
        await htLogd(
            tester, 'Failed BAR-T95 Password fields can contain min 8 characters', '', 'FINISHED');
      }
    });
  });
}
