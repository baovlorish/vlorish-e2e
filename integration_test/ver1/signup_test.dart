...
void main() async {
  ...
  group('Authentication Test', () {
    testWidgets('SignUp Page', (tester, [String? context]) async {
      ...
      try {
        await htLogdDirect(
            'BAR-T2 User sees error message if enter an invalid email', '', 'STARTED');
        ...
        await signUpScreen.verifyErrorMessage(
            ...
            context: context);
        await htLogd(
            tester, 'BAR-T2 User sees error message if enter an invalid email', '', 'FINISHED');
      } catch (e) {
        await htLogd(tester, 'Failed BAR-T2 User sees error message if enter an invalid email', '',
            'FINISHED');
      }

      try {
        await htLogdDirect('BAR-T4 User sees error message if Email field is empty', '', 'STARTED');
        await dashboardScreen.clickLogoText();
        await signInScreen.clickBtnSignUp(tester, context: context);
        ...
        await htLogd(
            tester, 'BAR-T4 User sees error message if Email field is empty', '', 'FINISHED');
      } catch (e) {
        await htLogd(tester, 'Failed BAR-T4 User sees error message if Email field is empty', '',
            'FINISHED');
      }
      ...
      try {
        ...
        await signUpScreen.inputEmail(getRandomString(10) + '@gmail.com', tester, context: context);
        await signUpScreen.clickButtonNext(tester, context: context);
        ...
        await signUpScreen.verifyErrorMessage('Please enter your password', tester);
        await signUpScreen.verifyErrorMessage('Please confirm your password', tester);
        await htLogd(
            tester,
            'BAR-T8 User see error message if Password fields are empty after clicking “Agree & Continue” button',
            '',
      ...
      try {
        await htLogdDirect(
            'BAR-T9 User see error message if one of the Password fields is empty', '', 'STARTED');
        await signUpScreen.clickBtnSignIn(tester, context: context);
        await signInScreen.clickBtnSignUp(tester, context: context);
        await signUpScreen.inputEmail(getRandomString(10) + '@gmail.com', tester, context: context);
        await signUpScreen.clickButtonNext(tester, context: context);
        ...
        await signUpScreen.verifyErrorMessage('Please confirm your password', tester);
        await signUpScreen.inputPassword('', tester, context: context);
        await signUpScreen.inputConfirmPassword('Test124\$', tester, context: context);
        await signUpScreen.clickAgreeAndContinueBtn(tester, context: context);
        await signUpScreen.verifyErrorMessage('Please enter your password', tester);
        await htLogd(tester, 'BAR-T9 User see error message if Confirm Password fields is empty',
            '', 'FINISHED');
      } catch (e) {
        await htLogd(
            tester,
      ...
      try {
        ...
        await signUpScreen.inputPassword('1ABV123#24', tester, context: context);
        ...
        await signUpScreen.inputConfirmPassword('AB1V123#2', tester, context: context);
      ...
      try {
        await htLogdDirect(
            'BAR-T21 User can enter max128 characters in Password fields', '', 'STARTED');
        await dashboardScreen.clickLogoText();
        await signInScreen.clickBtnSignUp(tester, context: context);
        await signUpScreen.inputEmail(getRandomString(10) + '@gmail.com', tester, context: context);
        await signUpScreen.clickButtonNext(tester, context: context);
        ...
        await signUpScreen.verifyErrorMessage(
            ...
            context: context);
        await htLogd(
            tester, 'BAR-T21 User can enter max128 characters in Password fields', '', 'FINISHED');
      } catch (e) {
        await htLogd(tester, 'Failed BAR-T21 User can enter max128 characters in Password fields',
            '', 'FINISHED');
      }
      ...
      try {
        ...
        await signUpScreen.verifySigupPersonalInfoPage(tester);
        await signUpScreen.clickButtonNext(tester);
        await signUpScreen.verifyMessageErrorIsVisible('Please enter your first name', tester);
        await signUpScreen.verifyMessageErrorIsVisible('Please enter last name', tester);
        await signUpScreen.verifyMessageErrorIsVisible('Please chose your gender', tester);
      ...
      try {
        await htLogdDirect(
            'BAR-T28 User cannot enter city that does not exist in "City" feild', '', 'STARTED');
        ...
        await htLogd(tester, 'BAR-T28 User cannot enter city that does not exist in "City" feild',
            '', 'FINISHED');
      } catch (e) {
        await htLogd(
            tester,
      ...
      try {
        ...
        await htLogd(tester, 'Failed BAR-T29 User can select gender', '', 'FINISHED');
      }

      try {
        await htLogdDirect('BAR-T31 First name field contains max 50 characters', '', 'STARTED');
        ...
        await htLogd(tester, 'BAR-T31 First name field contains max 50 characters', '', 'FINISHED');
      } catch (e) {
        await htLogd(
            tester, 'Failed BAR-T31 First name field contains max 50 characters', '', 'FINISHED');
      }

      try {
        await htLogdDirect('BAR-T32 Last name field contains max 50 characters', '', 'STARTED');
        final email31 = getRandomString(10) + '@gmail.com';
        await dashboardScreen.clickLogoText();
        await signInScreen.clickBtnSignUp(tester);
        await signUpScreen.inputEmail(email31, tester, context: context);
        ...
        await htLogd(tester, 'BAR-T32 Last name field contains max 50 characters', '', 'FINISHED');
      } catch (e) {
        await htLogd(
            tester, 'Failed BAR-T32 Last name field contains max 50 characters', '', 'FINISHED');
      }
      ...
      try {
        ...
        await signUpScreen.inputEmail(getRandomString(10) + '@gmail.com', tester, context: context);
        await signUpScreen.clickButtonNext(tester, context: context);
        await signUpScreen.clickAndVerifyPrivacyLink(homeURL, tester, context: context);
        await htLogd(
            tester,
            'BAR-T11 User is redirected on Privacy page after clicking on Privacy link',
            '',
      ...
      try {
        ...
        await signUpScreen.clickAndVerifyTermLink(homeURL, tester, context: context);
        await htLogd(
            tester,
            'BAR-T10 User is redirected on Terms&Conditions page after clicking on Terms link',
            '',
