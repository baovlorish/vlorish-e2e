...
if cat $DIR | grep -q 'Error'; then
echo -e '==========================================================='
echo -e '= ERROR DETAILS                                           ='
echo -e '==========================================================='
cat $DIR | pcregrep -M  '^@\-@\-.*@\|@\|$' | sed -e 's/\(@-@-,\)//g' | sed -e 's/\(,@|@|\)//g' | grep 'Error'
cat $DIR | pcregrep -M  '^@\-@\-.*@\|@\|$' | sed -e 's/\(@-@-,\)//g' | sed -e 's/\(,@|@|\)//g' | grep 'Error' >> ./integration_test/failTest.txt
fi
echo -e '==========================================================='
echo -e '= STEPS                                                   ='
echo -e '==========================================================='
